...
public class MouseCursor : MonoBehaviour {
    ...
    {
        // 모든 렌더링이 완료될 때까지 대기할테니 렌더링이 완료되면 깨워 달라고 유니티 엔진에 게 부탁하고 대기합니다.
        yield return new WaitForEndOfFrame();

        // 텍스처의 중심을 마우스의 좌표로 사용하는 경우 텍스처의 폭과 높이의 1/2을 hot Spot 좌표로 입력합니다.
        if(hotSpotIsCenter)
        {
        ...
        {
            // 중심을 사용하지 않을 경우 Adjust Hot Spot으로 입력 받은 것을 사용합니다.
